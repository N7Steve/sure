...
- El enlace de históricos proyecta la cadencia hacia atrás aunque la fecha de inicio sea futura y siempre considera explícitamente el movimiento desde el que se creó la programación. Para el resto exige la misma cuenta, moneda, nombre, categoría, comercio y conjunto de etiquetas, además del signo y tipo correctos; admite ±5 días y una variación de importe de ±5 % para importes fijos o ±40 % para importes variables estimados. También comprueba los dos extremos de transferencias y respeta omisiones/rechazos y huecos pendientes.
